...
// File: contracts/interface/IAccessControl.sol
...
// File: contracts/tokens/Extension/ERC721URIStorage.sol
...
interface IERC721Enumerable is IERC721 {
    ...
    /**
     * @dev Returns a token IDs owned by `owner` from token list.
     * Use along with {balanceOf} to enumerate all of ``owner``'s tokens.
     */
    function tokenIDsByAddress(address owner)
        external
        view
...
// File: contracts/tokens/Extension/ERC721Enumerable.sol
        ...
        returns (uint256[] memory)
    {
        ...
        if (length > 0) {
            for (uint256 i = 0; i < length; i++) {
                userToken[i] = _ownedTokens[owner][i];
            }
        }
        return userToken;
    }
...
// File: contracts/tokens/Extension/ERC721Burnable.sol
 ...
 */
abstract contract ERC721Burnable is ContextMixin, ERC721 {
    /**
